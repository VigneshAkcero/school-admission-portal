...
```
2. Generate a shared development certificate once:
```bash
...
npm run dev:https
```
4. Admin portal (HTTPS):
```bash
cd admin-portal
npm install
npm run dev:https
```
5. Student portal (HTTPS):
```bash
cd student-portal
npm install
npm run dev:https
...
```bash
cd "/Working Portal/backend"
npm run dev:https
```
3. Admin portal over HTTPS:
```bash
cd "/Working Portal/admin-portal"
npm run dev:https
```
4. Student portal over HTTPS:
```bash
cd "/Working Portal/student-portal"
npm run dev:https
```
