      ...
      <section className="grid gap-6 xl:grid-cols-[1.2fr_1fr]">
        <div className="rounded-[30px] border border-white/80 bg-white/90 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
          ...
          <div className="grid gap-4">
            <ProfileField label="Name" value={user.name || "Principal"} />
        ...
        <div className="rounded-[30px] border border-white/80 bg-white/90 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
          ...
          <p className="mt-2 text-sm text-slate-500">Switch the principal workspace between light and dark mode.</p>
