...
export default function ExamPage() {
  ...
  const subjectList = useMemo(() => {
    ...
    const orderedSubjects = ["english", "mathematics", "evs", "science", "telugu", "hindi"];
    return orderedSubjects.filter((subject) => session.questions.some((q) => findSubjectKey(q.subject) === subject));
  }, [session]);
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6]">
      ...
      <div className="mx-auto grid max-w-7xl items-start gap-6 px-4 py-6 md:px-6 xl:grid-cols-[minmax(0,1fr)_340px]">
        <div className="space-y-4">
