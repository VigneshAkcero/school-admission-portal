...
export default function CodeEntryPage() {
  ...
  const normalizedCode = testCode.toUpperCase().replace(/[^A-Z0-9]/g, "");

  async function verifyCode() {
    setError("");
    if (!/^MPS\d{9}$/.test(normalizedCode)) {
      setError("Please enter a valid 12-character test code (e.g. MPS260305007).");
      return;
    }
          ...
          <div className="premium-card rounded-[32px] border border-blue-100/70 bg-white/92 p-8 shadow-[0_26px_80px_rgba(148,163,184,0.18)] md:p-10">
            <div className="mb-12 text-center">
              ...
              <p className="text-sm font-bold leading-relaxed text-slate-500">
                Enter your 12-character test code to continue.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={testCode}
                  maxLength={12}
                  onChange={(e) => setTestCode(e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, "").slice(0, 12))}
                  placeholder="Enter test code (e.g. MPS260305007)"
